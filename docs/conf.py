# -*- coding: utf-8 -*-
#
# repoze.lemonade documentation build configuration file
#
...
latex_documents = [
  ('index', 'lemonade.tex', 'repoze.lemonade Documentation',
